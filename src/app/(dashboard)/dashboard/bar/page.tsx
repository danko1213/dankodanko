...
import { Loader2, Wine, Wifi, WifiOff, Volume2, VolumeX } from "lucide-react";
...
export default function BarPage() {
  ...
  const barOrders = orders
    ...
    .filter((o) => o.items.some((i) => i.destination === "bar"));
    ...
    <div className="p-4">
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold text-gray-900">Бар</h1>
      ...
      {ordersLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="mt-3 text-lg text-gray-400">Няма поръчки за бара</p>
        </div>
      ) : (
